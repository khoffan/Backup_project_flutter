  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        ...
        builder: (context, snapshot) {
          if (!snapshot.hasData) {
            return Container(
              child: Text('Get Data Errors'),
            );
          }
          final getTotalAmount = snapshot.data!.docs.first;
          dynamic data = getTotalAmount.data();
                              ...
                              if (((valueFirst == true ||
                                ...
                                if (amount < 50.00) {
                                  msgErr = "เงินในวอลเล็ตของคุณไม่เพียงพอ";
                                    ...
                                    valueThird == false)) {
                                  msgErr =
                                      "กรุณาเลือกสถานที่ที่ต้องการใช้บริการ";
                                ...
                                child: TextButton(
                                  onPressed: () {
                                    if ((valueFirst == true ||
                                      ...
                                      if (amount < 10.00) {
                                        msgErr2 =
                                            "เงินในวอลเล็ตของคุณไม่เพียงพอ";
                                      } else if (valueFirst == false ||
                                          valueSecond == false ||
                                          valueThird == false) {
                                        msgErr2 =
                                            "กรุณาเลือกสถานที่ที่ต้องการรับส่ง";
                                      }
